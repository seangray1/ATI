...
import getSharinPixImageList from '@salesforce/apex/SharinPixMoveImagesController.getSharinPixImageList';
...
export default class MoveImageSharinpix extends LightningElement {
    ...
    selectedViewType = 'detailView';//Sel view type for display
