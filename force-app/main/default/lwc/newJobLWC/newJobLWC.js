...
// }
@wire(getPicklistValues, { recordTypeId: '0120g000000l3yMAAQ', fieldApiName: MARKETCLASS_FIELD })
...
@wire(getPicklistValues, { recordTypeId: '0120g000000l3yMAAQ', fieldApiName: MARKETSEGMENT_FIELD })
...
@wire(getPicklistValues, { recordTypeId: '0120g000000l3yMAAQ', fieldApiName: MARKETSEGMENTSUBCLASS_FIELD })
...
MarketClassChange(event){
    ...
    try{
        ...
        if(this.MarketClass === 'Residential'){ this.NonResidential = false;
        ...
        switch(this.MarketClass){
            ...
            case 'Non-Residential':
             ...
             this.MarketSegmentOptions = this.MarketSegmentValues.filter(opt => opt.validFor.includes(key));
    }
    catch(err){
    ...
    try{
        ...
        switch(this.MarketSegment){
            ...
            case 'State/Municipal':
             ...
             this.MarketSegmentSubClassOptions = this.MarketSegmentSubClassValues.filter(opt => opt.validFor.includes(key));
    }
...
TakenByChange(event){
    window.clearTimeout(this.delayTimeout);
       var searchKey = event.target.value;
       if(searchKey.length === 0){this.TakenByUsers = null;}
       if(searchKey.length >= 1){
...
CreateNewJob(){
            ...
            if(this.billToCount > 1 || this.callerCount > 1){
                ...
                this.callerCount = 0;
                    ...
                    if(this.Description === "" || this.Description === undefined || this.DateOfLoss === "" || this.DateOfLoss === undefined ||this.JobName === "" || this.JobName === undefined || this.Division === "" || this.Division === undefined || this.MarketSegment === "" || this.MarketSegment === undefined
                    || this.MarketClass === "" || this.MarketClass === undefined || this.LeadSource === "" || this.LeadSource === undefined || this.OfficeValue === undefined || this.OfficeValue === "" || this.TakenByValue === undefined || this.TakenByValue === ""){
                        this.billToCount = 0;
                this.projectSiteContactCount = 0;
                this.callerCount = 0;
                        alert('Fill in all required Job Fields');
                    }else{
                        if(this.MarketClass === 'Non-Residential' && (this.MarketSegmentSubClass === "" || this.MarketSegmentSubClass === undefined)){
                            this.billToCount = 0;
                            this.projectSiteContactCount = 0;
                            this.callerCount = 0;
            ...
            //Job Fields
            JobJSON = JSON.stringify({'Description': this.Description, 'Division': this.Division, 'Office': this.OfficeId, MarketSegment: this.MarketSegment,
            ...
            MarketSegmentSubClass: this.MarketSegmentSubClass,MarketClass: this.MarketClass});
