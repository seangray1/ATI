...
export default class SharinPixPaginatorComp extends LightningElement {
    ...
    setRecordsToDisplay() {
        ...
        /*** Performance updates */
		let test1 = this.records;
        console.log('total records - ' + test1.length);
        this.recordsToDisplay = test1.slice(this.pageSize * (this.pageNumber - 1),  this.pageSize * this.pageNumber );
        console.log('$$$ recordsToDisplay - ' + this.recordsToDisplay.length);
        /************************ */
