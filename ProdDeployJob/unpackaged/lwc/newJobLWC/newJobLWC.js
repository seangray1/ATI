...
export default class NewJobLWC extends NavigationMixin(LightningElement) {
                 ...
                 @track JobTemp;
                 @track AccountRoles = [{}];
                 @track ContactInfoAndDescription;
                 @track MajorEvents;
                 ...
                 connectedCallback() {
                   ...
                   if (this.TypeOfJobEntry === "AfterHoursJobEntry") {
                     GetJobInfo({ recordId: this.jobrecordId }).then(
                       (result) => {
                         ...
                         if (
                           ...
                           console.log(
                             "Project Director is " +
                               jobresults.Project_Manager__r.Name
                           );
                         ...
                         if (
                           ...
                           console.log(
                             "Major Event is " + jobresults.Major_Event__c
                           );
                           console.log(
                             "Major Event is " + jobresults.Major_Event__r.Name
                           );
                           this.MajorEventValue =
                   ...
                   GetAccountRolesPicklist({}).then((result) => {
                     ...
                     for (
                       var i = 0;
                       i < AccountRolePicklistValues.length;
                       i++
                     ) {
                   ...
                   //     if(this.TypeOfJobEntry === 'AfterHoursJobEntry' && this.PropertyPrompt === false){
                   //         this.NewProperty = true;
                   //     }
                   // })
                 ...
                 NewAccountRoleSelected(event) {
                   ...
                   this.MultipleRoles = this.AccountRoles[
                     this.MultRoleInd
                   ].Multiple_Roles__c;
                 ...
                 saveMultipleRoles() {
                   this.AccountRoles[
                     this.MultRoleInd
                   ].Multiple_Roles__c = this.MultipleRoles;
                   this.newAccountRoles = false;
                   this.MultRoleInd = "";
                   this.MultipleRoles = "";
                 }
                 ...
                 saveAccount() {
                   ...
                   if (!input) {
                     ...
                     console.log(
                       "Company Account Roles " + this.CompanyAccountRoles
                     );
                     if (
                       this.CompanyAccountRoles === null ||
                       this.CompanyAccountRoles === ""
                 ...
                 ReplaceEmptyAccountRoleRows() {
                   ...
                   for (let k = 0; k < RowCount; k++) {
                     ...
                     let ARContact = TblRow[k].querySelector(".ARContact")
                       .value;
                     let ARAccount = TblRow[k].querySelector(".ARAccount")
                       .value;
                 ...
                 AccountSelectionChange(e) {
                   ...
                   console.log(
                     "ContactAccoutnValue is " + this.ContactAccountValue
                   );
                 }
                 ToggleNewCaller() {
                   this.NewAccount = false;
                 ...
                 populatePropertyField(event) {
                   ...
                   console.log(
                     "Street " + this.PropertySelectedField.Address_Line_1__c
                   );
                   ...
                   checkId({ propId: this.testingProperty.Id }).then(
                     (result) => {
                       let data = result;
                       // if(data != undefined && data != null && data.length != null){
                       if (JSON.stringify(data) !== "[]") {
                   ...
                   GetMasterJobs({ propId: this.testingProperty.Id }).then(
                     (result) => {
                       this.MasterJobs = result;
                       console.log("Master Jobs " + this.MasterJobs);
                       if (JSON.stringify(this.MasterJobs) !== "[]") {
                         console.log(
                           "Master Jobs result " +
                             JSON.stringify(this.MasterJobs)
                         );
                         this.bShowModal = true;
                       }
                     }
                 ...
                 populateMasterJobField(event) {
                   ...
                   if (
                    this.MasterJobDetails.Job_Class__c !== "" &&
                    this.MasterJobDetails.Job_Class__c !== undefined
                  ) {
                    this.JobClass = this.MasterJobDetails.Job_Class__c;
                 ...
                 CreateNewJob() {
                   ...
                   if (this.ARRoleBlank) {
                     ...
                     if (this.billToCount > 1 || this.callerCount > 1) {
                       alert(
                         "Only One Primary/Bill-to and Caller can be selected as a Role"
                       );
                       this.billToCount = 0;
                       this.projectSiteContactCount = 0;
                       this.callerCount = 0;
                       ...
                       if (
                         ...
                         if (this.PropertyID === "" && this.Address === "") {
                           ...
                           this.callerCount = 0;
                           alert(
                             "Either Select a Property or Create a New Property"
                           );
                         } else {
                 ...
                 GetAccountRolesObjects() {
                   ...
                   for (let Actindex = 0; Actindex < ActRowCount; Actindex++) {
                     ...
                     let ARRoles = ActTblRow[Actindex].querySelector(".ARRoles")
                       .value;
                     let ARContact = ActTblRow[Actindex].querySelector(
                       ".ARContact"
                     ).value;
                     let ARAccount = ActTblRow[Actindex].querySelector(
                       ".ARAccount"
                     ).value;
                     console.log(
